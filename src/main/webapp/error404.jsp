 ...
 .sign.error-page-wrapper .buttons-container a:hover .fa-home {
  ...
  @media screen and (max-width: 500px) {
   ...
   .sign.error-page-wrapper .buttons-container .fa {
    ...
    .background-color {
      background-color: rgba(17, 136, 176, 1) !important;
    }
...
<div class="text-container">
	...
	<div class="buttons-container">
		<a class="border-button" href="http://localhost:8080/Testing/index.jsp" target="_blank"><span class="fa fa-home"></span> Home Page</a>
		<a class="border-button" href="mailto:ruslan.omelchenko.irtcits@gmail.com" target="_blank"><span class="fa fa-warning"></span> Report Problem</a>
	</div>
</div>
